...
focusableElements = [
	...
	// { section: 'list-music-1', selector: '.cover-slide-1', defaultElement: ''},
	// { section: 'list-music-2', selector: '.cover-slide-2', defaultElement: ''},
	// { section: 'list-music-3', selector: '.cover-slide-3', defaultElement: ''},
	{ section: 'music-artist', selector: '.cover-slide', defaultElement: ''},
